...
%           urlcolor=cyan,    % color for linked URLs
	        ...
	        pdftitle={80832-margarida-ferreira-dissertacao},
            pdfauthor={Margarida Ferreira},
            pdfsubject={FOREST: An Interactive Multi-tree Synthesizer for Regular Expressions},
            pdfkeywords={Program Synthesis, Programming by Example, Satisfiability Modulo Theories, Regular Expressions, Form Validation},
            pdfstartview=FitV,
